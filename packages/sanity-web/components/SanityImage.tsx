import type { ImageCrop, ImageHotspot } from '@sanity/types';
...
export type SanityImageProps = {
  /**
   * OPTIONAL: The aspect ratio of the image, in the format of `width/height`.
   * If not set, will use the default aspect ratio of the image.
   *
   * @example
   * ```
